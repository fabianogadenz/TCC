...
\titulo{{ DESENVOLVIMENTO DE UM APLICATIVO PARA DISPOSITIVOS MÓVEIS PARA USO DE MAPEAMENTO DE EMBALAGENS DE MEDICAMENTOS}} % titulo do trabalho em portugues
\title{\MakeUppercase{DEVELOPING AN APPLICATION FOR MOBILE DEVICES FOR MEDICINE PACKAGING MAPPING}} % titulo do trabalho em ingles
